		$(document).ready(function() {
			...
			var muerte = setInterval(function() {
				...
				var y =$( "#juego" ).height();
				 ...
				 $( "#caja1" ).css( "left", getRandomInt(0, variablewith) );
				 $( "#caja1" ).css( "top", getRandomInt(0, variableheigth) );
				...
				var y =$( "#juego" ).height();
				 ...
				 $( "#caja2" ).css( "left", getRandomInt(x/2, variablewith) );
				 $( "#caja2" ).css( "top", getRandomInt(0, variableheigth) );
				...
				var y =$( "#juego" ).height();
				 ...
				 $( "#caja3" ).css( "left", getRandomInt(0, variablewith) );
				 $( "#caja3" ).css( "top", getRandomInt(y/2, variableheigth) );
					$("#caja3").show();
					estado2=false; 
